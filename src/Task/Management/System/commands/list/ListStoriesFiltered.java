...
public class ListStoriesFiltered extends BaseCommand {
    ...
    public static final String HEADER_FOR_ONE_FILTER = "--STORIES FILTERED BY %s--";
    public static final String HEADER_FOR_TWO_FILTERS = "--STORIES FILTERED BY %s AND %s--";
    ...
    public static final String EMPTY_FILTERED_COLLECTION = "No stories match the filtering criteria!";
