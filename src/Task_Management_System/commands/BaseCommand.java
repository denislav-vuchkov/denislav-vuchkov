...
public abstract class BaseCommand implements Command {
    ...
    public static final String ATTEMPTED_CHANGE = "User %s: Attempted to modify the %s of %s with ID %d to %s.";
    ...
    public static final String USER_CREATED_TASK = "User %s: Added a new %s with ID %d in board %s.";
